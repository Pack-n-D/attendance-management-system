...
import { TrendingUp, Users, PlusCircle, FileSpreadsheet, Settings, Clock, KeyRound, Receipt } from 'lucide-react';
...
export default function AdminSidebar() {
  ...
  const navItems = [
    ...
    { path: '/admin/reimbursements', label: 'Reimbursements', icon: Receipt },
